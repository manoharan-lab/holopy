...
gold_single = np.array([1.5768,0.0001,6.62e-7,5.54e-6,5.79e-6,14.2e-6,0.6398,7.119,2])
gold_dimerslow = np.array([1.6026,1.6026,0.00001,0.00001,6.857e-7,6.964e-7,
    1.6998e-5,1.739e-5,2.0927e-5,1,-29.78,-13.83,5.447e-25,16.722,1.000,0.000])
...
gold_trimerslow = np.array([1.5894,1.598,1.599,1.00e-5,1.00e-5,1.00e-5,5.00e-7,5.00e-7,
    5.00e-7,6.00e-6,6.00e-6,7.02e-6,0.60948,40.678,12.0806,4.438,4.795,1.00,0.00])
...
class TestFit:
    ...
    def test_mie_noisysingle(self):
        ...
        assert_array_almost_equal(fit_result,gold_single,
    ...
    def test_tmatrix_noisydimer_slow(self):
        ...
        assert_array_almost_equal(fit_result,gold_dimerslow,
    ...
    def test_tmatrix_noisytrimer_slow(self):
        ...
        assert_array_almost_equal(fit_result,gold_trimerslow,
